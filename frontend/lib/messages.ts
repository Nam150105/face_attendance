...
const CODE_MESSAGES: Record<string, string> = {
  ...
  HOURS_ORDER_INVALID: "Giờ ra phải sau giờ vào trong cùng một ngày. Ca đêm sẽ được hỗ trợ sau.",
  NIGHT_SHIFT_NOT_SUPPORTED: "Ca đêm chưa được hỗ trợ. Hiện chỉ chọn được ca ngày.",
