...
const CODE_MESSAGES: Record<string, string> = {
  ...
  SESSION_EXPIRED: "Lượt vào của bạn thuộc ngày hôm trước, phiên đã khép lúc 00:00 nên không chấm ra được nữa. Bạn gửi yêu cầu chỉnh công để người quản lý ghi giờ ra giúp.",
  ALREADY_CHECKED_OUT: "Hôm nay bạn đã chấm ra rồi. Ngày mai chấm vào lại.",
  HOURS_REQUIRED: "Địa điểm phải có giờ vào và giờ ra.",
  HOURS_ORDER_INVALID: "Ca ngày: giờ ra phải sau giờ vào trong cùng một ngày. Ca vắt qua nửa đêm thì chọn Ca đêm.",
  NIGHT_HOURS_MUST_CROSS_MIDNIGHT: "Ca đêm phải vắt qua nửa đêm: giờ vào buổi tối, giờ ra sáng hôm sau (ví dụ 22:00 – 06:00).",
